...
| internvl | s/img | 条件 |
|---|---|---|
| 卡 0 | **6.0** | 2026-09-09 00:4x,卡 1 在跑 internvl |
| 卡 0 | 10.0 | 主运行 22:10–22:57,卡 1 在跑 qwen3vl,**且桌面端还开着** |
| 卡 1 | 14.6 | 主运行 23:33– |

同一张卡、同一个检测器,6.0 与 10.0 差 67%,**原因未定**。两个候选:那段时间
ChatGPT 桌面端还没关(你 23:2x 才关),或者卡 1 当时跑的是 qwen3vl 而不是 internvl。
空载基准会把这个也一并解决——所以更要等卡真的空了再测,别再拿脏数据下结论。
